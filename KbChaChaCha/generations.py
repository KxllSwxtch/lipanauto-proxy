...
cookies = {
    ...
    "_ga_BQD4DF40J4": "GS2.1.s1751522090$o5$g1$t1751522775$j60$l0$h132702711",
}
...
response = requests.get(
    "https://www.kbchachacha.com/public/search/carName.json",
    params=params,
    cookies=cookies,
    headers=headers,
)
